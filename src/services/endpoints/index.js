...
export const GET_WEATHER_16_DAYS = (latitude, longitude, days) =>
  `/onecall?lat=${latitude}&lon=${longitude}&cnt=${days}&appid=f34e0bd4e3f94975277166607b0e8a9e&units=metric`;
